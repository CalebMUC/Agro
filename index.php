...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>ALVET & AGRO CHEMICALS LTD</title>
	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>ALVET & AGRO CHEMICALS LTD</h2>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>ALVET AND AGRO CHEMICALS LTD</h2>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">ALVET & AGRO CHEMICALS LTD &copy; </h3>
			<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">ALVET & AGRO CHEMICALS LTD<span>CALEBM</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">0794129559</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="Caleb:muchiricaleb05@gmail.com" style="color:white">muchiricaleb05@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About ALVET & AGRO CHEMICALS LTD</b></span>
				ALvet & AGRO CHEMICALS LTD is e-commerce trading platform for animal products and animal supplimentary
			</p>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="Login/register.php" method='POST'>
    <div class="imgcontainer">
